...
namespace CarStoreDatabaseAccess.Migrations
{
    ...
    [Migration("20200713230922_ChangedDeleteBehavior")]
            ...
            modelBuilder.Entity("CarStoreDatabaseAccess.DatabaseModels.Ad", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        ...
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 595, DateTimeKind.Local).AddTicks(3243));
                    ...
                    b.Property<DateTime>("ModifiedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 601, DateTimeKind.Local).AddTicks(5254));
            ...
            modelBuilder.Entity("CarStoreDatabaseAccess.DatabaseModels.Feature", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 617, DateTimeKind.Local).AddTicks(9372));
                    ...
                    b.Property<DateTime>("ModifiedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 617, DateTimeKind.Local).AddTicks(9724));
            ...
            modelBuilder.Entity("CarStoreDatabaseAccess.DatabaseModels.Role", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 619, DateTimeKind.Local).AddTicks(2424));
                    ...
                    b.Property<DateTime>("ModifiedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 619, DateTimeKind.Local).AddTicks(2750));
            ...
            modelBuilder.Entity("CarStoreDatabaseAccess.DatabaseModels.Town", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 621, DateTimeKind.Local).AddTicks(4725));
                    ...
                    b.Property<DateTime>("ModifiedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 621, DateTimeKind.Local).AddTicks(5020));
            ...
            modelBuilder.Entity("CarStoreDatabaseAccess.DatabaseModels.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 623, DateTimeKind.Local).AddTicks(4294));
                    ...
                    b.Property<DateTime>("ModifiedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 623, DateTimeKind.Local).AddTicks(4630));
            ...
            modelBuilder.Entity("CarStoreDatabaseAccess.DatabaseModels.Vehicle", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 632, DateTimeKind.Local).AddTicks(2759));
                    ...
                    b.Property<DateTime>("ModifiedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 632, DateTimeKind.Local).AddTicks(3214));
            ...
            modelBuilder.Entity("CarStoreDatabaseAccess.DatabaseModels.VehicleType", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 633, DateTimeKind.Local).AddTicks(9601));
                    ...
                    b.Property<DateTime>("ModifiedDateTime")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 14, 1, 9, 22, 633, DateTimeKind.Local).AddTicks(9946));
